		...
		<script type="text/javascript">
						...
						//获取字段拼接表单
						 $.post("returnZdmList",{
							 	guidBmodel :guidBmodel
									 ...
									 fromInput+="<input id='guidBmodel' name='guidBmodel' style='display: none' value='<%=request.getParameter("guidBmodel")%>'  >";
			...
			<div class="site-text site-block">
				...
				<input id="flag"  style="display: none"
						...
						lay-verify="required" class="layui-input">
				<form id="layui-form" class="layui-form" action="doc_doEdit" onsubmit="return fomrSubmit(this);" method="post" >
				</form>
				<script type="text/javascript">
