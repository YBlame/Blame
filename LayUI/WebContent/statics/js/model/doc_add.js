						 ...
						 for(var i=0;i<result.length;i++){
							if (result[i].jsdmFlag!=0) {
							 ...
							 case "text"://文本类型
							   ...
							   case "datetime"://时间
							   		if (result[i].isedit==1) {
							   			fromInput +="<div class='layui-form-item'> <div class='layui-inline'><label class='layui-form-label'>"+result[i].zdmc+isform+"</label><div class='layui-input-inline'><input type='text' class='layui-input' name='"+result[i].zdm+"' id='test5' style='width:"+result[i].width+"px;' readonly placeholder='yyyy-MM-dd HH:mm:ss'></div></div></div>";
								    	
									}else{
										fromInput +="<div class='layui-form-item'> <div class='layui-inline'><label class='layui-form-label'>"+result[i].zdmc+isform+"</label><div class='layui-input-inline'><input type='text' class='layui-input' name='"+result[i].zdm+"'  readonly style='width:"+result[i].width+"px;' placeholder='yyyy-MM-dd HH:mm:ss'></div></div></div>";
									}
							    	break;
							    case "checkbox"://多选
							    ...
							    case "pic":
							    	fromInput+="<div class='layui-form-item layui-form-text'><label class='layui-form-label'>"+result[i].zdmc+isform+"</label><input type='file'  id='"+result[i].zdm+"'  name='"+result[i].zdm+"' ></div>"
							 }
		            	 }
						 var guid =  $("#uuid").val();
